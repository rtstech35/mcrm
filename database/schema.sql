...
(2, 'Satış Müdürü', 'Satış departmanı yöneticisi', 3, true, '{
    "customers": ["read", "create", "update", "delete"], "orders": ["read", "create", "update", "delete"], "appointments": ["read", "create", "update"], "delivery": ["read"], "accounting": ["read"], "users": ["read"], "roles": ["read"], "departments": ["read"],
    "admin_dashboard": true, "admin_customers": true, "admin_orders": true, "admin_appointments": true, "admin_delivery_notes": true, "admin_accounts": true,
...
(4, 'Depo Müdürü', 'Depo ve envanter yönetimi yöneticisi', 3, true, '{
    ...
    "admin_dashboard": true, "admin_products": true
}'),
...
(6, 'Sevkiyat Sorumlusu', 'Sevkiyat yöneticisi, kendisine atanan sevkiyatları yönetir', 3, true, '{
    ...
    "admin_dashboard": true, "admin_delivery_notes": true, "shipping_dashboard": true, "shipping_delivery_notes": true, "shipping_map": true
}'),
...
(8, 'Üretim Müdürü', 'Üretim yöneticisi, tüm siparişleri görür ve işlem yapar', 3, true, '{
    "orders": ["read", "update"], "production": ["read", "update"], "admin_dashboard": true, "admin_orders": true,
...
(10, 'Muhasebe Müdürü', 'Muhasebe departmanı yöneticisi', 3, true, '{
    "accounting": ["read", "create", "update", "delete"], "customers": ["read"], "delivery": ["read"], "invoices": ["read", "create"],
    "admin_dashboard": true, "admin_accounts": true, "admin_customers": true, "admin_delivery_notes": true,
