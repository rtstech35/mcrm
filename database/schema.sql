...
(2, 'Satış Müdürü', 'Satış departmanı yöneticisi', 3, true, '{"customers": ["read", "create", "update", "delete"], "orders": ["read", "create", "update", "delete"], "products": ["read"], "appointments": ["read", "create", "update"], "delivery": ["read"], "accounting": ["read"], "users": ["read"], "roles": ["read"], "departments": ["read"], "admin_dashboard": true, "admin_users": true, "admin_customers": true, "admin_products": true, "admin_orders": true, "admin_departments": true, "admin_roles": true, "admin_permissions": true, "admin_delivery_notes": true, "admin_appointments": true, "admin_accounts": true, "sales_dashboard": true, "sales_customers": true, "sales_orders": true, "sales_delivery_notes": true, "sales_appointments": true, "sales_accounts": true, "sales_invoices": true, "sales_map": true}'),
(3, 'Satış Personeli', 'Sadece kendi müşterilerini görür ve işlem yapar', 2, true, '{"customers": ["read", "read_own", "create"], "orders": ["read", "read_own", "create"], "products": ["read"], "appointments": ["read", "read_own", "create"], "visits": ["create"], "sales_dashboard": true, "sales_customers": true, "sales_orders": true, "sales_appointments": true, "sales_new_visit": true, "sales_map": true}'),
(4, 'Depo Müdürü', 'Depo ve envanter yönetimi yöneticisi', 3, true, '{"products": ["read", "create", "update", "delete"], "inventory": ["read", "create", "update", "delete"], "delivery": ["read"], "admin_dashboard": true, "admin_products": true, "admin_delivery_notes": true}'),
(5, 'Depo Personeli', 'Depo ve envanter işlemleri', 2, true, '{"products": ["read", "update"], "inventory": ["read", "update"], "admin_products": true}'),
(6, 'Sevkiyat Sorumlusu', 'Sevkiyat yöneticisi, kendisine atanan sevkiyatları yönetir', 3, true, '{"delivery": ["read", "create", "update", "delete"], "orders": ["read"], "admin_dashboard": true, "admin_delivery_notes": true, "shipping_dashboard": true, "shipping_delivery_notes": true, "shipping_map": true}'),
(7, 'Sevkiyatçı', 'Kendisine atanan sevkiyatları görür ve işlem yapar', 2, true, '{"delivery": ["read", "read_own", "update"], "orders": ["read_own"], "shipping_dashboard": true, "shipping_delivery_notes": true, "shipping_map": true}'),
(8, 'Üretim Müdürü', 'Üretim yöneticisi, tüm siparişleri görür ve işlem yapar', 3, true, '{"orders": ["read", "update"], "production": ["read", "update"], "products": ["read"], "admin_dashboard": true, "admin_orders": true, "production_dashboard": true, "production_orders": true}'),
(9, 'Üretim Personeli', 'Tüm siparişleri görür ve üretim işlemlerini yapar', 2, true, '{"orders": ["read", "update"], "production": ["read", "update"], "products": ["read"], "production_dashboard": true, "production_orders": true}'),
...
(11, 'Muhasebe Personeli', 'Mali işler ve muhasebe işlemleri', 2, true, '{"accounting": ["read", "create", "update"], "customers": ["read"], "orders": ["read"], "invoices": ["read", "create", "update"], "accounting_dashboard": true, "accounting_customers": true, "accounting_invoices": true, "accounting_accounts": true}')
