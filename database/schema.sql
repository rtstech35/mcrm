...
(7, 'Sevkiyatçı', 'Kendisine atanan sevkiyatları görür ve işlem yapar', 2, true, '{"delivery": ["read_own", "update"], "orders": ["read_own"], "admin_delivery_notes": true, "shipping_dashboard": true, "shipping_delivery_notes": true, "shipping_map": true}'),
...
(9, 'Üretim Personeli', 'Tüm siparişleri görür ve üretim işlemlerini yapar', 2, true, '{"orders": ["read", "update"], "production": ["read", "update"], "products": ["read"], "admin_orders": true, "production_dashboard": true, "production_orders": true}'),
