...
async function apiCall(url, options = {}) {
    try {
        ...
        const response = await fetch(url, {
            ...options,
            headers: headers,
            // 'no-cache' sunucudan 304 Not Modified yanıtı almasına neden olabilir,
            // bu da response body'sinin boş olmasına ve .json() hatasına yol açar.
            // 'reload' her zaman sunucudan tam yanıtı alır ve 304 sorununu önler.
            cache: 'reload'
        });
